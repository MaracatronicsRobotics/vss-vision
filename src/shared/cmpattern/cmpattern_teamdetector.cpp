...
void TeamDetector::init(RobotPattern * robotPattern, Team * team)
{
  ...
  //read config:
  _unique_patterns=(team->_team_name->getString() == "Default") ? false : _robotPattern->_unique_patterns->getBool();
  _have_angle=(team->_team_name->getString() == "Default") ? false : _robotPattern->_have_angle->getBool();
